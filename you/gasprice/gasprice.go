...
import (
	...
	"github.com/youchainhq/go-youchain/internal"
...
func NewOracle(backend internal.Backend, params Config) *Oracle {
...
func (gpo *Oracle) SuggestPrice(ctx context.Context) (*big.Int, error) {
	...
	for sent < gpo.checkBlocks && blockNum > 0 {
		go gpo.getBlockPrices(ctx, types.MakeSigner(big.NewInt(int64(blockNum))), blockNum, ch)
		sent++
		exp++
		blockNum--
	}
