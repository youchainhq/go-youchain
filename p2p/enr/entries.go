...
// RUDP is the "rudp" key, which holds the rudp port of the node.
// type RUDP uint16

type RUDP uint16

func (v RUDP) ENRKey() string { return "rudp" }
...
func (v NAT) ENRKey() string { return "nat" }

//@Matt: add nodetype
type NODETYPE uint16

func (v NODETYPE) ENRKey() string { return "nodetype" }
