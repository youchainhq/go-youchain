...
import (
	...
	"github.com/youchainhq/go-youchain/common/compiler"
...
func init() {
	...
	app.Version = version
	app.Description = fmt.Sprintf("Revision:%s Time:%s", gitCommit, gitTime)
	app.Flags = []cli.Flag{
		abiFlag,
		binFlag,
		typeFlag,
	...
	app.Action = abigen
	// Restore the default help template
	app.CustomAppHelpTemplate = utils.CliDefaultHelpTemplate
}
