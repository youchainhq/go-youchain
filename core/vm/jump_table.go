...
func GetJumpTable(evmVersion string) [256]operation {
	switch evmVersion {
	case params.EvmIstanbul:
		return istanbulInstructionSet
	default:
		// SHOULD NOT happened, just panic for debug
		panic("unsupported evm version: " + evmVersion)
	}
}
...
func newIstanbulInstructionSet() JumpTable {
	set := newConstantinopleInstructionSet()

	// New opcode
	set[NETWORKID] = operation{
		execute:     opNetworkId,
	...
	set[SSTORE].dynamicGas = gasSStoreEIP2200
