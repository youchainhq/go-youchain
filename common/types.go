...
// MarshalJSON return a **mixed-case** string in hash syntax
...
func (s SortedAddresses) Less(i, j int) bool { return s[i].Big().Cmp(s[j].Big()) < 0 }
func (s SortedAddresses) Search(a Address) int {
	return sort.Search(len(s), func(i int) bool {
		return s[i].Big().Cmp(a.Big()) >= 0
	})
}
