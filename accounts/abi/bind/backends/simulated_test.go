...
import (
	...
	"github.com/youchainhq/go-youchain/accounts/abi"
...
func TestSimulatedBackend(t *testing.T) {
	...
	auth := bind.NewKeyedTransactor(key, params.NetworkIdForTestCase)
	...
	tx, _ = types.SignTx(tx, types.MakeSigner(big.NewInt(0)), key)
...
func TestSimulatedBackend_NonceAt(t *testing.T) {
	...
	signedTx, err := types.SignTx(tx, types.MakeSigner(big.NewInt(0)), testKey)
	if err != nil {
...
func TestSimulatedBackend_EstimateGas(t *testing.T) {
	...
	gas, err := sim.EstimateGas(bgCtx, youchain.CallMsg{
		From:  testAddr,
		To:    &testAddr,
...
func TestSimulatedBackend_PendingCodeAt(t *testing.T) {
	...
	auth := bind.NewKeyedTransactor(testKey, params.NetworkIdForTestCase)
...
func TestSimulatedBackend_PendingAndCallContract(t *testing.T) {
	...
	contractAuth := bind.NewKeyedTransactor(testKey, params.NetworkIdForTestCase)
	...
	res, err := sim.PendingCallContract(bgCtx, youchain.CallMsg{
		From: testAddr,
		To:   &addr,
		Data: input,
	})
	...
	res, err = sim.CallContract(bgCtx, youchain.CallMsg{
		From: testAddr,
		To:   &addr,
		Data: input,
	}, nil)
